...
//! - [`SliceGridBits`]: A mutable, borrowed view over an existing slice.
//!
//! # Examples
//!
//! Creating an owned `VecGridBits` and accessing an element:
//! ```
//! use grixy::{Pos, buf::bit::VecBits};
//!
...
use crate::{GridError, Pos, internal::Sealed};
...
mod tests {
    ...
    use crate::{
        Pos,
        buf::bit::{ArrayBits, SliceBits, SliceMutBits, VecBits},
    };
